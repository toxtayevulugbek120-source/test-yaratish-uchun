...
QUESTIONS += [
    ...
    # PDF 3: Problems 89-120+ (2-QISM va Ko'rsatkichli tengsizliklar)
    # Section 5a: Ratsional tengsizliklar (2-qism)
    
    {"num":89, "q": mg(mf("(x−2)²(x+3)³","x²−9x+20"), mr(" ≤ 0")),
     "A": mr("[−3 ; 4) ∪ (5 ; +∞)"),
     "B": mr("(−∞ ; −3] ∪ [4 ; 5)"),
     "C": mr("[−3 ; 2] ∪ [4 ; 5)"),
     "D": mr("(−3 ; 4) ∪ (5 ; +∞)"),
    ...
    {"num":91, "q": mg(mf("(x−2)(x−5)","(x−3)²"), mr(" > 0")),
     "A": mr("(−∞ ; 2) ∪ (5 ; +∞)"),
     "B": mr("(2 ; 3) ∪ (3 ; 5)"),
     "C": mr("(−∞ ; 2) ∪ (3 ; 5)"),
     "D": mr("(2 ; 5) ∖ {3}"),
    ...
    {"num":93, "q": mg(mf("(x+1)²(x−3)","(x+4)"), mr(" ≤ 0")),
     "A": mr("(−∞ ; −4) ∪ [−1 ; 3]"),
     "B": mr("[−4 ; −1] ∪ [3 ; +∞)"),
     "C": mr("(−∞ ; −4] ∪ [−1 ; 3]"),
     "D": mr("(−4 ; 3]"),
    ...
    {"num":94, "q": mg(mf("x³+8","(x−1)(x+3)"), mr(" > 1")),
     "A": mr("(−3 ; −2) ∪ (1 ; +∞)"),
     "B": mr("(−∞ ; −3) ∪ (−2 ; 1)"),
     "C": mr("(−2 ; 1)"),
     "D": mr("(−3 ; 1) ∪ (1 ; +∞)"),
    ...
    # Section 5b: Ratsional tengsizliklar (davomi)
    
    {"num":95, "q": mg(mf("x²+3x−2","x²−2x−8"), mr(" < 3")),
     "A": mr("(−2 ; 2) ∪ (4 ; +∞)"),
     "B": mr("(−∞ ; −2) ∪ (2 ; 4)"),
     "C": mr("(−2 ; 4)"),
     "D": mr("(2 ; 4)"),
    ...
    {"num":96, "q": mg(mf("x²−3x","x²+2x+8"), mr(" ≤ 0")),
     "A": mr("[0 ; 3]"),
     "B": mr("(−∞ ; 0] ∪ [3 ; +∞)"),
     "C": mr("(0 ; 3)"),
     "D": mr("ℝ"),
    ...
    {"num":97, "q": mg(mf("2x−3","x+2"), mr(" ≥ "), mf("3x−5","x−1")),
     "A": mr("(−2 ; ¹¹⁄₅] ∪ [1 ; +∞)"),
     "B": mr("[−2 ; 1) ∪ [¹¹⁄₅ ; +∞)"),
     "C": mr("(−2 ; 1) ∪ (¹¹⁄₅ ; +∞)"),
     "D": mr("(−∞ ; −2) ∪ [¹¹⁄₅ ; +∞)"),
    ...
    {"num":98, "q": mg(mf("x²+2x−3","x²−4x+3"), mr(" > "), mf("x+5","x−3")),
     "A": mr("(−∞ ; −3) ∪ (1 ; 2) ∪ (3 ; +∞)"),
     "B": mr("(−3 ; 1) ∪ (2 ; 3)"),
     "C": mr("(−∞ ; −3] ∪ [1 ; 2] ∪ [3 ; +∞)"),
     "D": mr("(1 ; 3)"),
    ...
    # Section 6: Ko'rsatkichli tengsizliklar (Exponential Inequalities - 2-QISM)
    
    {"num":99, "q": mg(mr("(x−3)"), msup("","4"), mr(" − 5(x−3)"), msup("","2"), mr(" − 36 ≥ 0")),
     "A": mr("(−∞ ; 0] ∪ [6 ; +∞)"),
     "B": mr("[0 ; 6]"),
     "C": mr("(−∞ ; 0) ∪ (6 ; +∞)"),
     "D": mr("(0 ; 6)"),
    ...
    {"num":100, "q": mg(mr("(x²−2x)"), msup("","2"), mr(" + (x−1)"), msup("","2"), mr(" ≤ 13")),
     "A": mr("[−1 ; 3]"),
     "B": mr("(−∞ ; −1] ∪ [3 ; +∞)"),
     "C": mr("(−1 ; 3)"),
     "D": mr("ℝ"),
    ...
    {"num":101, "q": mg(mr("(x²+2x)"), msup("","2"), mr(" + (x+1)"), msup("","2"), mr(" ≤ 73")),
     "A": mr("[−4 ; 2]"),
     "B": mr("(−∞ ; −4] ∪ [2 ; +∞)"),
     "C": mr("(−4 ; 2)"),
     "D": mr("[−3 ; 1]"),
    ...
    {"num":102, "q": mg(msup("x","9"), mr(" > 5"), msup("","9")),
     "A": mr("(5 ; +∞)"),
     "B": mr("(−∞ ; 5)"),
     "C": mr("[5 ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":103, "q": mg(msup("x","7"), mr(" > 2"), msup("","7")),
     "A": mr("(2 ; +∞)"),
     "B": mr("(−∞ ; 2)"),
     "C": mr("[2 ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":104, "q": mg(msup("x","4"), mr(" ≤ x"), msup("","7")),
     "A": mr("[0 ; 1]"),
     "B": mr("(−∞ ; 0] ∪ [1 ; +∞)"),
     "C": mr("(0 ; 1)"),
     "D": mr("ℝ"),
    ...
    # Ko'rsatkichli tengsizliklar (davomi)
    
    {"num":105, "q": mg(msup("x","6"), mr(" ≤ 3"), msup("","8")),
     "A": mr("[0 ; 3]"),
     "B": mr("(−∞ ; 0] ∪ [3 ; +∞)"),
     "C": mr("(0 ; 3)"),
     "D": mr("[−3 ; 3]"),
    ...
    {"num":106, "q": mg(mr("(x−4)"), msup("","7"), mr(" > (2x+3)"), msup("","7")),
     "A": mr("(−7 ; +∞)"),
     "B": mr("(−∞ ; −7)"),
     "C": mr("[−7 ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":107, "q": mg(mr("(x²−5x)"), msup("","13"), mr(" < (8−3x)"), msup("","13")),
     "A": mr("(−∞ ; 2) ∪ (4 ; +∞)"),
     "B": mr("(2 ; 4)"),
     "C": mr("(−∞ ; 2] ∪ [4 ; +∞)"),
     "D": mr("[2 ; 4]"),
    ...
    # Section 14-20: Tengsizliklarni sistemasini yeching
    
    {"num":108, "q": mr("6 + 7x > 2x + 4x   va   −3x + 20 < x + 7x + 4"),
     "A": mr("(6 ; +∞)"),
     "B": mr("(−∞ ; 6)"),
     "C": mr("[6 ; +∞)"),
     "D": mr("∅"),
    ...
    {"num":109, "q": mg(msup("x","2"), mr(" + 6x − 10 ≥ 0   va   x² − 3x + 20 < x² + 7x + 4")),
     "A": mr("[2 ; +∞)"),
     "B": mr("(−∞ ; 2]"),
     "C": mr("(2 ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":110, "q": mg(mf("(x−2)(x−6)","(x−4)"), mr(" ≤ 0")),
     "A": mr("[2 ; 4) ∪ [6 ; +∞)"),
     "B": mr("(−∞ ; 2] ∪ (4 ; 6]"),
     "C": mr("[2 ; 6]"),
     "D": mr("(2 ; 4) ∪ (6 ; +∞)"),
    ...
    {"num":111, "q": mg(mr("0 ≤ x − "), mf("16x","x²+7"), mr(" ≤ 7")),
     "A": mr("[1 ; 7]"),
     "B": mr("(−∞ ; 1] ∪ [7 ; +∞)"),
     "C": mr("(1 ; 7)"),
     "D": mr("[0 ; 7]"),
    ...
    {"num":112, "q": mg(mf("6x","x²+7"), mr(" ≤ x² + 7x ≤ 7x")),
     "A": mr("[0 ; 6]"),
     "B": mr("(−∞ ; 0] ∪ [6 ; +∞)"),
     "C": mr("(0 ; 6)"),
     "D": mr("[−6 ; 6]"),
    ...
    {"num":113, "q": mg(mf("x²+7x+6","x²−x−6"), mr(" ≤ 1x")),
     "A": mr("[−3 ; −2) ∪ (3 ; +∞)"),
     "B": mr("(−∞ ; −3] ∪ [−2 ; 3)"),
     "C": mr("[−3 ; 3)"),
     "D": mr("(−2 ; 3)"),
    ...
    # 21-56: Tengsizliklarni sistemasini yeching (davomi)
    
    {"num":114, "q": mg(mr("{  "), mf("3x−5","x²+1"), mr(" < 2 ;   "), mf("x+1","x−2"), mr(" ≥ 0  }")),
     "A": mr("(−∞ ; −1] ∪ (2 ; +∞)"),
     "B": mr("[−1 ; 2)"),
     "C": mr("(−∞ ; −1) ∪ [2 ; +∞)"),
     "D": mr("(−1 ; 2)"),
    ...
    # PDF 4: Problems 115-150+ (Qo'shimcha ratsional tengsizliklar va sistemalar)
    
    {"num":115, "q": mg(mr("(x−3)"), msup("","4"), mr(" > x"), msup("","4")),
     "A": mr("(3 ; +∞)"),
     "B": mr("(−∞ ; 3)"),
     "C": mr("[3 ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":116, "q": mg(mr("(6x−4)(7+x)"), msup("","8"), mr(" ≤ 0")),
     "A": mr("[−7 ; ⅔]"),
     "B": mr("(−∞ ; −7] ∪ [⅔ ; +∞)"),
     "C": mr("(−7 ; ⅔)"),
     "D": mr("[−7 ; ⅔) ∪ (⅔ ; +∞)"),
    ...
    {"num":117, "q": mg(mr("(5x+4)(x−5)"), msup("","12"), mr(" ≥ 0")),
     "A": mr("(−∞ ; −⁴⁄₅] ∪ [5 ; +∞)"),
     "B": mr("[−⁴⁄₅ ; 5]"),
     "C": mr("(−∞ ; −⁴⁄₅) ∪ (5 ; +∞)"),
     "D": mr("(−⁴⁄₅ ; 5)"),
    ...
    # Section 5: Ratsional tengsizliklar (2-4 qismlar)
    
    {"num":118, "q": mg(mf("(x−3)²","(x+4)²"), mr(" > 1")),
     "A": mr("(−½ ; +∞)"),
     "B": mr("(−∞ ; −½)"),
     "C": mr("[−½ ; +∞)"),
     "D": mr("(−∞ ; −½] ∪ [−½ ; +∞)"),
    ...
    {"num":119, "q": mg(mf("x²+2x","x²+x−12"), mr(" < 1")),
     "A": mr("(−∞ ; −4) ∪ (2 ; 3)"),
     "B": mr("(−4 ; 2) ∪ (3 ; +∞)"),
     "C": mr("(−∞ ; −4] ∪ [2 ; 3]"),
     "D": mr("[−4 ; 2] ∪ [3 ; +∞)"),
    ...
    {"num":120, "q": mg(mf("x²−3x+2","x²+x−2"), mr(" ≥ 1")),
     "A": mr("(−∞ ; −2) ∪ [0 ; 1)"),
     "B": mr("[−2 ; 0] ∪ [1 ; +∞)"),
     "C": mr("(−2 ; 1)"),
     "D": mr("(−∞ ; −2] ∪ [0 ; 1]"),
    ...
    {"num":121, "q": mg(mf("x²+4x+3","x²−4x+3"), mr(" ≤ 1")),
     "A": mr("(−∞ ; 0] ∪ (1 ; 3)"),
     "B": mr("[0 ; 1) ∪ [3 ; +∞)"),
     "C": mr("(−∞ ; 0) ∪ [1 ; 3]"),
     "D": mr("[0 ; 3]"),
    ...
    # Section 5a: Ratsional tengsizliklar (3-qism)
    
    {"num":122, "q": mg(mf("x²+x−12","x²+2x+15"), mr(" ≥ 0")),
     "A": mr("(−∞ ; −4] ∪ [3 ; +∞)"),
     "B": mr("[−4 ; 3]"),
     "C": mr("(−∞ ; −4) ∪ (3 ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":123, "q": mg(mf("x+2","x²+5x+7"), mr(" ≤ 0")),
     "A": mr("(−∞ ; −2]"),
     "B": mr("[−2 ; +∞)"),
     "C": mr("(−∞ ; −2)"),
     "D": mr("∅"),
    ...
    {"num":124, "q": mg(mf("x²+3x","x²+x+1"), mr(" < 0")),
     "A": mr("(−3 ; 0)"),
     "B": mr("(−∞ ; −3) ∪ (0 ; +∞)"),
     "C": mr("[−3 ; 0]"),
     "D": mr("(−∞ ; −3] ∪ [0 ; +∞)"),
    ...
    {"num":125, "q": mg(mf("x²−x−2","x²+3x+3"), mr(" > 0")),
     "A": mr("(−∞ ; −1) ∪ (2 ; +∞)"),
     "B": mr("(−1 ; 2)"),
     "C": mr("(−∞ ; −1] ∪ [2 ; +∞)"),
     "D": mr("ℝ"),
    ...
    # Section 5b: Ratsional tengsizliklar (4-qism - davomi)
    
    {"num":126, "q": mg(mf("x²+5x","x²−2x+3"), mr(" ≥ 0")),
     "A": mr("(−∞ ; −5] ∪ [0 ; +∞)"),
     "B": mr("[−5 ; 0]"),
     "C": mr("(−∞ ; −5) ∪ (0 ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":128, "q": mg(mf("x²+7x+10","x²+6x+10"), mr(" < 0")),
     "A": mr("(−5 ; −2)"),
     "B": mr("(−∞ ; −5) ∪ (−2 ; +∞)"),
     "C": mr("[−5 ; −2]"),
     "D": mr("∅"),
    ...
    {"num":129, "q": mg(mf("x²−9","x²+4x+5"), mr(" ≥ 0")),
     "A": mr("(−∞ ; −3] ∪ [3 ; +∞)"),
     "B": mr("[−3 ; 3]"),
     "C": mr("(−∞ ; −3) ∪ (3 ; +∞)"),
     "D": mr("ℝ"),
    ...
    # Section 5c: Ratsional tengsizliklar va sistemalar (2-4-qism)
    
    {"num":130, "q": mg(mr("y = "), msup("√(25x²−1)",""), mr("   funksiyaning aniqlanish sohasi")),
     "A": mr("(−∞ ; −⅕] ∪ [⅕ ; +∞)"),
     "B": mr("[−⅕ ; ⅕]"),
     "C": mr("(−∞ ; −⅕) ∪ (⅕ ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":131, "q": mg(mr("y = "), msup("√(x²−1)",""), mr(" − 1   funksiyaning aniqlanish sohasi")),
     "A": mr("(−∞ ; −1] ∪ [1 ; +∞)"),
     "B": mr("[−1 ; 1]"),
     "C": mr("(−∞ ; −1) ∪ (1 ; +∞)"),
     "D": mr("ℝ"),
    ...
    {"num":132, "q": mg(mr("y = "), msup("√(x²−7x)",""), mr(" + "), msup("√(x−1)",""), mr("   funksiya sohasi")),
     "A": mr("[1 ; +∞)"),
     "B": mr("(−∞ ; 0] ∪ [7 ; +∞)"),
     "C": mr("[0 ; 1] ∪ [7 ; +∞)"),
     "D": mr("(−∞ ; 0] ∪ [1 ; +∞)"),
    ...
    {"num":133, "q": mg(mr("y = "), mf("√(x²+20x+7)","x+7"), mr("   funksiya sohasi")),
     "A": mr("(−∞ ; −7) ∪ [−1 ; +∞)"),
     "B": mr("[−7 ; −1]"),
     "C": mr("(−7 ; −1)"),
     "D": mr("(−∞ ; −7] ∪ [−1 ; +∞)"),
    ...
    {"num":134, "q": mg(mr("y = "), mf("x²+7x+12","√(x²−9)"), mr("   funksiya sohasi")),
     "A": mr("(−∞ ; −3) ∪ (3 ; +∞)"),
     "B": mr("[−3 ; 3]"),
     "C": mr("(−3 ; 3)"),
     "D": mr("(−∞ ; −3] ∪ [3 ; +∞)"),
    ...
    # Tengsizliklar yeching (qo'shimcha)
    
    {"num":135, "q": mr("Tengsizlikni yeching:   x² + 2x − 7 < 10 ) − y > 12"),
     "A": mr("(−∞ ; −5) ∪ (3 ; +∞)"),
     "B": mr("(−5 ; 3)"),
     "C": mr("[−5 ; 3]"),
     "D": mr("(−∞ ; −5] ∪ [3 ; +∞)"),
    ...
    {"num":136, "q": mg(mr("Tengsizlikni sistemasini yeching:   {  "), mf("x²−17x+16","(x²−5x+6)(x²−1)"), mr(" > 0  }")),
     "A": mr("(1 ; 2) ∪ (3 ; 16)"),
     "B": mr("(−∞ ; 1) ∪ (2 ; 3) ∪ (16 ; +∞)"),
     "C": mr("[1 ; 2) ∪ (3 ; 16]"),
     "D": mr("(−1 ; 1) ∪ (2 ; 3) ∪ (16 ; +∞)"),
    ...
    {"num":137, "q": mg(mr("Tengsizlikni sistemasini yeching:   {  "), mf("x²+6x+16","x²+x−6"), mr(" < 0  ;  "), mf("x+8","x²+6x+10"), mr(" ≥ 0  }")),
     "A": mr("[−8 ; −3)"),
     "B": mr("(−∞ ; −8] ∪ [−3 ; +∞)"),
     "C": mr("(−8 ; −3)"),
     "D": mr("[−8 ; −3]"),
    ...
    {"num":138, "q": mg(mr("Iqtidorli o'quvchilar uchun:   "), mf("x²+x−12","x²+13x+36"), mr(" ≤ 0")),
     "A": mr("[−9 ; −4) ∪ [3 ; +∞)"),
     "B": mr("(−∞ ; −9] ∪ [−4 ; 3]"),
     "C": mr("(−9 ; −4] ∪ [3 ; +∞)"),
     "D": mr("[−4 ; 3]"),
    ...
    {"num":139, "q": mg(mr("Necha butun son y = "), msup("√(25x²−36)",""), mr(" funksiyaning aniqlanish sohasiga tegishli?")),
     "A": mr("∅   (cheksiz ko'p)"),
     "B": mr("{0}"),
     "C": mr("{−1 ; 0 ; 1}"),
     "D": mr("{−2 ; −1 ; 0 ; 1 ; 2}"),
    ...
    {"num":140, "q": mg(mr("Necha butun son y = "), mf("√(x²−7x)","x−1"), mr(" funksiyaning aniqlanish sohasiga tegishli?")),
     "A": mr("5   {2, 3, 4, 5, 6}"),
     "B": mr("4   {2, 3, 4, 5}"),
     "C": mr("6   {1, 2, 3, 4, 5, 6}"),
     "D": mr("Cheksiz ko'p"),
